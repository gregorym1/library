...
<form class="" name="contact_form" action="/action-servlet" method="post">
    <ul class="topmenu">
        <button name="showAllVisitors" class="submit" type="submit" > Все посетители </button>
        <button name="showActiveVisitors" class="submit" type="submit" > Активные посетители </button>
        <button name="showPassiveVisitors" class="submit" type="submit" > Пассивные посетители </button>
    </ul>
