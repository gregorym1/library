...
<form class="" name="contact_form" action="/action-servlet" method="post">
    <ul class="topmenu">
        <button name="showAllBooks" class="submit" type="submit" > Все книги </button>
        <button name="showVisitorBooks" class="submit" type="submit"> Книги на руках </button>
        <button name="showLibraryBooks" class="submit" type="submit"> Книги в библиотеке </button>
    </ul>
